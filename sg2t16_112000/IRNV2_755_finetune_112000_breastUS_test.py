...
np.savetxt('correctIncResNetV2_775_112000.csv',true_classes,delimiter=',')

# Test data n predictive labels (n = 300)
pred_classes = np.argmax(model.predict(X_test[0:300]), axis = 1)
print('prediction:', pred_classes)
np.savetxt('predictionsIncResNetV2_775_112000.csv',pred_classes,delimiter=',')

# Confusion Matrix
print('2x2_IncRenNetV2_775_sg2t16_112000')
# Benign Prediction
#                     Predicted
#                 Malig(0)  Benign(1)
...
plt.grid()
plt.savefig('/sg2t16_112000/Real_BreastUS_IRNV2_Test_roc_curve.png')
