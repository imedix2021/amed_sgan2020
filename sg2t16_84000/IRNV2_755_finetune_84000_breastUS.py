...
# Data acquisition
# ZIP read - Rewrite the path according to the location of the 'sg2t16_56000' folder.
z = zipfile.ZipFile('/sg2t16_84000/hikakudata.zip')
...
def model_save(model_name):
    ...
    with open(model_dir +"BreastUS_SG2T16_84000_cross" + model_name + ".json", "w") as json_file:
     json_file.write(model_json)
    model.save(model_dir + 'model_' + model_name + '.hdf5')
    model.save_weights(weights_dir + 'BreastUS_SG2T16_84000_cross' + model_name + '.h5')
...
def model_evaluate():
    ...
    fileobj = open("InceptionvResNet_V2_775_255_SG2T16_84000_results.txt", "w")
...
# InceptionResNetV2
f = open(model_dir + "BreastUS_SG2T16_56000_crossInceptionResNetV2_775.json", 'r')
loaded_model_json = f.read()
f.close()
model = model_from_json(loaded_model_json)
model.load_weights(weights_dir + 'BreastUS_SG2T16_56000_crossInceptionResNetV2_775.h5')
...
hist=model_fit()
learning_plot("InceptionResNetV2_775_SG2T16_84000")
model_evaluate()
model_save("InceptionResNetV2_775_SG2T16_84000")
save_history(hist, os.path.join(result_dir, 'history_inceptionresnetv2_775_SG2T16_84000.txt'))
