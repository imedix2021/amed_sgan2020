...
hist=model_fit()
learning_plot("InceptionResNetV2_775_real")
model_evaluate()
model_save("InceptionResNetV2_775_real")
save_history(hist, os.path.join(result_dir, 'history_inceptionresnetv2_775_real.txt'))
